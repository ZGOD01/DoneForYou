...
export default function TopMarquee() {
  return (
    <div className="fixed top-0 left-0 w-full z-50">
      <div className="backdrop-blur-md bg-white border-b border-black/20 py-2 flex items-center">
        {/* Logo */}
        <img
          src={myLogo}
        ...
        <marquee
          ...
          direction="left"
          scrollamount="6"
          className="text-black text-sm md:text-base font-medium tracking-wide"
        >
